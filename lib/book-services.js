        ...
        return new Promise(async resolve => {
            try {
                for (const section of sections) {
                    await BookServices.updateSectionHtml(section);
                }
                resolve(book);
            } catch (error) {
                log.exception('BookServices.updateSectionsHtml');
            }
        });
    }
    ...
    */
    ...
    static localizeSectionsImages(book) {
        ...
        return new Promise(async resolve => {
            try {
                for (const section of sections) {
                    await BookServices.localizeSectionImages(section);
                }
                resolve(book);
            } catch (error) {
                log.exception('BookServices.localizeSectionsImages');
            }
        });
    }
